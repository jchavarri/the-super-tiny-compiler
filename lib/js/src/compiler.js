      ...
      if (exit$2 === 3) {
        if (current) {
          ...
          if (typeof match$3 === "number") {
            ...
            _current = /* Some */[/* String */Block.__(1, [match$3[0] + Char.escaped(head)])];
            _input = tail;
            continue ;
        ...
        if (head >= 32) {
          if (head < 58) {
              ...
              if (head >= 48) {
                if (current) {
                  ...
                  if (typeof match$4 === "number") {
                    ...
                    _current = /* Some */[/* Number */Block.__(0, [match$4[0] + Char.escaped(head)])];
                    _input = tail;
                    continue ;
                    
                  }
                } else {
                  _current = /* Some */[/* Number */Block.__(0, [Char.escaped(head)])];
                  _input = tail;
                  continue ;
            ...
            if (typeof match$5 === "number") {
              ...
              _current = /* Some */[/* Name */Block.__(2, [match$5[0] + Char.escaped(head)])];
              _input = tail;
              continue ;
            ...
            _current = /* Some */[/* Name */Block.__(2, [Char.escaped(head)])];
            _input = tail;
            continue ;
...
function transformer(astList) {
  var wrapNode = function (n) {
    return /* TExpressionStatement */Block.__(3, [n]);
  };
  var transform = function (astNode) {
    switch (astNode.tag | 0) {
      case 0 : 
          return /* TNumber */Block.__(0, [astNode[0]]);
      case 1 : 
          return /* TString */Block.__(1, [astNode[0]]);
      case 2 : 
          var nl = List.map(transform, astNode[1]);
  ...
  return List.map(wrapNode, List.map(transform, astList));
}

function codeGenerator(nodes) {
  var codeGenerate = function (node) {
    switch (node.tag | 0) {
      case 0 : 
      case 1 : 
          return node[0];
      case 2 : 
          return $$String.concat("", /* :: */[
                      ...
                      /* :: */[
                        "(",
                        /* :: */[
                          $$String.concat(",", List.rev(List.map(codeGenerate, node[1]))),
                          /* :: */[
                            ")",
                            /* [] */0
                          ]
                    ...
                    /* :: */[
                      ...
                      /* :: */[
                        ...
                        /* :: */[
                          ...
                          /* :: */[
                            List.fold_left((function (acc, x) {
                                    return debugTransformedAstNode(x, tabs + "--") + acc;
                                  }), "", astNode[1]),
                            /* [] */0
                          ]
                        ]
    ...
    case 3 : 
        return $$String.concat("", /* :: */[
                    ...
                    /* :: */[
                      "ExpressionStatement: ",
                      /* :: */[
                        debugTransformedAstNode(astNode[0], tabs + "--"),
                        /* [] */0
                      ]
                    ]
                  ]);
...
console.log(codeGenerator(testTransformer));
